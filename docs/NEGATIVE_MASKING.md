...
>
> HISTORICAL. Single-seed (n=1), phikon-v2-only ablation that fed into the final SPECTRA_BCLS=3.0 / SPECTRA_BMEAN=-inf choice. Do not generalize its absolute numbers to other backbones.
